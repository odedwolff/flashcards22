...
--
-- Dumping routines for database 'test_schema_17_oct'
--
/*!50003 DROP PROCEDURE IF EXISTS `inc_word` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `inc_word`(in wordArg char(100), inc integer)
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS `testProc3` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `testProc3`(in wordArg char(100))
BEGIN
		IF NOT (select exists(select * from test_schema_17_oct.words_stats) 
			where test_schema_17_oct.words_stats.WORD = wordArg
			) 
		THEN
			insert into test_schema_17_oct.words_stats (word, instances_cnt) value("then", 1);
		ELSE
			insert into test_schema_17_oct.words_stats (word, instances_cnt) value("else", 1);
        END IF;    
	END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `upateSCore` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `upateSCore`(wordId integer, correctInc integer, default_attempts integer, default_correct integer)
BEGIN
